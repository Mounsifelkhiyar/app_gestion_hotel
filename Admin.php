			...
			<div class="container">
				<div class="row">
					...
					<?php
										...
										{
											$requet=mysql_query('SELECT  IDADMIN 
                                              FROM  admin 
                                              WHERE  EMAILADMIN =  "'.$_POST['email'].'"
                                              AND  PASSWORDADMIN =  "'.$_POST['password'].'"');	

										
										if ($rs=mysql_fetch_array($requet))
										{


											echo "<h1>bien venu dans votre espace admin</h1>";
										?>
												...
												<div class="col-md-3" align="center">
													<a href="ghotel.php?action=listeHot"><h4>Gestion d'Hotels</h4></a>
													</div>
													<div class="col-md-3" align="center">
													<a href="greservation.php"><h4>Gestion de reservation</h4></a>
													</div>
										...
										<?php
											...
											else
											{
												...
												echo "<h1>email ou mot de pass incorrect</h1>";
										...
										{
											?> <div class="col-md-10 col-md-offset-1 animate-box">
										<form method="Post" action="ghotel.php?action=listeHot">
											<div class="row form-group">
												<div class="col-md-12">
													<label for="email">Email</label>
													<input type="text" name="email" class="form-control" placeholder="Votre adresse email">
